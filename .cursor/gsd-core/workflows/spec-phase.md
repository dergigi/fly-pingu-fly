...
ones). Reference: @/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/gigi/Development/vibe/fly-pingu-fly/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/templates/spec.md.
