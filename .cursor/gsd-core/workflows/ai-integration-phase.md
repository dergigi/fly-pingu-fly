...
<required_reading>
@/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/references/ai-frameworks.md
@/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/agents/gsd-eval-planner.md for instructions.
