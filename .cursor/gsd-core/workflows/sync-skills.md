...
INSTALL_JS_GLOBAL="/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
