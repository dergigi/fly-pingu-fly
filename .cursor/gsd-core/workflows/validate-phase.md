...
```
Agent(
  prompt="Read /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/templates/VALIDATION.md`
