...
- Usage: Reference from command with `@/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/gigi/Development/vibe/fly-pingu-fly/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
