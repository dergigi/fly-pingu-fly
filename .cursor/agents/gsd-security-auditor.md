...
**Verification depth scales with `asvs_level`** (see @/Users/gigi/Development/vibe/fly-pingu-fly/.cursor/gsd-core/references/security-asvs-levels.md for full definitions):
